...
TEST_CASE("Двусвязный список 8.2: GetFirst на пустом списке"){
    ...
    REQUIRE_THROWS_AS(list.GetFirst(), OutOfRangeException);
}
...
TEST_CASE("Двусвязный список 8.4: GetLast на пустом списке"){
    ...
    REQUIRE_THROWS_AS(list.GetLast(), OutOfRangeException);
}
...
TEST_CASE("Двусвязный список 8.6: Get с неверным индексом"){
    ...
    REQUIRE_THROWS_AS(list.Get(3), OutOfRangeException);
    REQUIRE_THROWS_AS(list.Get(100), OutOfRangeException);
}
...
TEST_CASE("Двусвязный список 9.6: InsertAt с неверным индексом"){
    ...
    REQUIRE_THROWS_AS(list.InsertAt(99, 5), OutOfRangeException);
    REQUIRE_THROWS_AS(list.InsertAt(99, 100), OutOfRangeException);
}
...
TEST_CASE("Двусвязный список 10.2: Set с неверным индексом"){
    ...
    REQUIRE_THROWS_AS(list.Set(3, 100), OutOfRangeException);
    REQUIRE_THROWS_AS(list.Set(100, 100), OutOfRangeException);
}
...
TEST_CASE("Двусвязный список 11.5: RemoveAt с неверным индексом"){
    ...
    REQUIRE_THROWS_AS(list.RemoveAt(3), OutOfRangeException);
    REQUIRE_THROWS_AS(list.RemoveAt(100), OutOfRangeException);
}
...
TEST_CASE("Двусвязный список 13.3: GetSubList с неверными индексами"){
    ...
    REQUIRE_THROWS_AS(list.GetSubList(3, 1), OutOfRangeException);
    REQUIRE_THROWS_AS(list.GetSubList(0, 5), OutOfRangeException);
    REQUIRE_THROWS_AS(list.GetSubList(2, 10), OutOfRangeException);
}
